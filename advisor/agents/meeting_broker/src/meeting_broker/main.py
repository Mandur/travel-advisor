"""Entrypoint for the meeting broker agent exposed via FastAPI."""
...
from meeting_broker.agent import create_agent
...
if __name__ == "__main__":
    uvicorn.run("meeting_broker_agent.main:app", host="0.0.0.0", port=8088, reload=False)
